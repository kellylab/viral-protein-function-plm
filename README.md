...
Installation:  
1. Download codebase
2. Environment setup using conda (for CPU or GPU). For MAC ARM users, if the installation does not work, either install with osx-64 or change to the following package versions: numpy==1.24.3, tensorflow==2.13.0
